...
public interface HelpBroker {
	/**
	 * Activated when the user presses help. Implementors will typically query
	 * the model to determine the current step and display the appropriate
	 * information.
	 * 
	 * @param parent
	 *            the component that is requesting the help. This is typically
