...
public interface WizardStep {
	...
	/**
	 * Gets the name of this step. This will be displayed in the title of the
	 * wizard while this step is active.
	 * 
	 ...
	 * confirmed the abort process and as such may be invoked after the step is
	 * no longer busy.
	 */
	void abortBusy();
	 ...
	 * This method will be called during wizard initialization to determine the
	 * correct size of the wizard. This method will be called after
	 * {@link #init}.
	 * 
