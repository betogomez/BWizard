...
public abstract class AbstractWizardModel implements WizardModel {
	...
	private boolean finishVisible = true;
	...
	/**
	 * Provided for subclasses to change the current step in response to a call
	 * to {@link #nextStep} or its related methods.
	 * 
	 * @param activeStep
	 *            the new step.
	 */
	 ...
	 *            <tt>true</tt> to enable the previous button, <tt>false</tt>
	 *            otherwise.
	 * @see #isPreviousVisible()
	 */
	 ...
	 * 
	 * @param nextAvailable
	 *            <tt>true</tt> to enable the next button, <tt>false</tt>
	 *            otherwise.
	 */
	 ...
	 * 
	 * @param lastAvailable
	 *            <tt>true</tt> to enable the last button, <tt>false</tt>
	 *            otherwise.
	 */
	 ...
	 *            <tt>true</tt> to enable the cancel button, <tt>false</tt>
	 *            otherwise.
	 */
	...
	/**
	 * Configures if the next button should be displayed.
	 * 
	 * @param nextVisible
	 *            <tt>true</tt> to display the next button, <tt>false</tt>
	 *            otherwise.
	 * @see #isNextVisible
	 */
	public void setNextVisible(boolean nextVisible) {
		if (this.nextVisible != nextVisible) {
			boolean old = this.nextVisible;
			this.nextVisible = nextVisible;
			pcs.firePropertyChange("nextVisible", old, nextVisible);
		}
	}

	/**
	 * Configures if the previous button should be displayed.
	 * 
	 * @param previousVisible
	 *            <tt>true</tt> to display the previous button, <tt>false</tt>
	 *            otherwise.
	 * @see #isPreviousVisible
	 */
	public void setPreviousVisible(boolean previousVisible) {
		if (this.previousVisible != previousVisible) {
			boolean old = this.previousVisible;
			this.previousVisible = previousVisible;
			pcs.firePropertyChange("previousVisible", old, previousVisible);
		}
	}

	/**
	 * Configures if the finish button should be displayed.
	 * 
	 * @param finishVisible
	 *            <tt>true</tt> to display the finish button, <tt>false</tt>
	 *            otherwise.
	 * @see #isFinishVisible
	 */
	public void setFinishVisible(boolean finishVisible) {
		if (this.finishVisible != finishVisible) {
			boolean old = this.finishVisible;
			this.finishVisible = finishVisible;
			pcs.firePropertyChange("finishVisible", old, finishVisible);
		}
	}

	/**
	 * This is an empty method that is intended for subclasses to override to
	 * update their various properties based on the active step.
	 */
	...
	/**
	 * Adds a listener to the "complete" property of the {@link WizardStep}.
	 * Any changes to this property will in automatically invoke
	...
	public void resetContextValues() {
		context.clear();
	}
}
