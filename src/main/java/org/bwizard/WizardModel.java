...
import org.bwizard.models.MultiPathModel;
...
public interface WizardModel {
	 ...
	 * 
	 * @return <tt>true</tt> if the previou button should be enabled,
	 ...
	 * {@link #isNextAvailable} returns <tt>true</tt>.
	 */
	public void nextStep();

	/**
	 * Takes the model back to the previsou step and fires the appropriate
	 ...
	 * wizard at all.
	 * 
	 * @return <tt>true</tt> if the last button should be displayed,
	 *         <tt>false</tt> otherwise.
	 */
	boolean isLastVisible();

	/**
	 * Checks if the next button should be displayed.
	 * 
	 * @return <tt>true</tt> if the next button should be displayed,
	 *         <tt>false</tt> otherwise.
	 */
	boolean isNextVisible();

	/**
	 * Checks if the previous button should be displayed.
	 * 
	 * @return <tt>true</tt> if the previous button should be displayed,
	 *         <tt>false</tt> otherwise.
	 */
	boolean isPreviousVisible();

	/**
	 * Checks if the finish button should be displayed.
	 * 
	 * @return <tt>true</tt> if the finish button should be displayed,
	 *         <tt>false</tt> otherwise.
	 */
	 ...
	 * @param step
	 *            the step to check
	 * @return <tt>true</tt> if its the final step in the wizard,
	 *         <tt>false</tt> otherwise.
	 */
	 ...
	 * is not guaranteed to the be the order of traversal.
	 * 
	...
	/**
	 * Called to request the model to update it current state. This will be
	 * called when ever a step transition occurs but may also be called by the
	 * current {@link WizardStep} to force a refresh.
	 */
